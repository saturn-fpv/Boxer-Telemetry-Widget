--[[#############################################################################
GPS Position viewer for RadioMaster Boxer (128x64 displays)
Based on "GPS Stats X9L.lua" by mosch  -  https://github.com/moschotto
Adapted for RadioMaster Boxer by saturn-fpv.
License GPLv2: http://www.gnu.org/licenses/gpl-2.0.html

Description:
Reads the "GPSpositions.txt" log file generated by the Boxer Telemetry.lua script.
Useful to check the last GPS coordinates after a crash, power loss, etc.

Copy "GPS Stats Boxer.lua" to the /SCRIPTS/TOOLS/ folder on the SD card.
################################################################################]]


local toolName = "TNS|GPS Stats Boxer|TNE"
